...
-- user.usertable: ~2 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `usertable` DISABLE KEYS */;
INSERT INTO `usertable` (`id`, `username`, `name`, `lastname`, `age`, `job`, `address`, `facebook`, `instagram`, `twitter`, `mail`, `password`) VALUES
	(2, 'tgrfed', 'rewq', 'rewqq', 34, 'rew', 'gre', 'rew', 'rew', 'rew', 'rew', 'ewq'),
	(14, 'Gülbahar', 'Gülbahar', 'Kankaya', 23, 'Coder', 'Bölmepınar', 'gulbaharkankaya', 'gulbaharkankaya', 'gulbaharkankaya', 'gulbaharkankaya.97@gmail.com', 'dfdsds');
